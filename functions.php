...
$url = "https://api.telegram.org/bot6080187351:6894932319:AAFmuhRnVYj_p3rwJqO-hZovo_2_4O239Uk/editMessageText?chat_id=".$chatId."&message_id=".$message_id."&text=".$message."&parse_mode=HTML";
file_get_contents($url);      
}
